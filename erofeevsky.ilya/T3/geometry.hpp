...
//ф-ции для работы с полигоном
  ...
  bool operator<=(const Polygon& lhs, const Polygon& rhs);//проверка вхождения полигона в другой
  bool isRightAngle(const Polygon& polygon);//проверка на наличие прямых углов
